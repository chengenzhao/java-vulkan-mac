...
public class PFN_vkCmdSetDepthWriteEnable {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkCmdSetDepthWriteEnable.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkCmdSetDepthWriteEnable.Function fi, Arena arena) {
