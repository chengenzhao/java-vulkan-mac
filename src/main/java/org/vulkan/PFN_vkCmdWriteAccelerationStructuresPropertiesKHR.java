...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkCmdWriteAccelerationStructuresPropertiesKHR)(VkCommandBuffer, uint32_t, const VkAccelerationStructureKHR *, VkQueryType, VkQueryPool, uint32_t)
 * }
 */
public class PFN_vkCmdWriteAccelerationStructuresPropertiesKHR {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkCmdWriteAccelerationStructuresPropertiesKHR.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkCmdWriteAccelerationStructuresPropertiesKHR.Function fi, Arena arena) {
