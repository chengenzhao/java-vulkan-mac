 ...
 * }
 */
public class PFN_vkGetAccelerationStructureDeviceAddressKHR {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetAccelerationStructureDeviceAddressKHR.Function.class, "apply", $DESC);
