 ...
 * }
 */
public class PFN_vkGetBufferDeviceAddressEXT {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetBufferDeviceAddressEXT.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkGetBufferDeviceAddressEXT.Function fi, Arena arena) {
