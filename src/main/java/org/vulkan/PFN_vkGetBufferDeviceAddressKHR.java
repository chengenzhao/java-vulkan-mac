 ...
 * }
 */
public class PFN_vkGetBufferDeviceAddressKHR {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetBufferDeviceAddressKHR.Function.class, "apply", $DESC);
