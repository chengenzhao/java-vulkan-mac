...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkGetDeviceImageSparseMemoryRequirements)(VkDevice, const VkDeviceImageMemoryRequirements *, uint32_t *, VkSparseImageMemoryRequirements2 *)
 * }
 */
public class PFN_vkGetDeviceImageSparseMemoryRequirements {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetDeviceImageSparseMemoryRequirements.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkGetDeviceImageSparseMemoryRequirements.Function fi, Arena arena) {
