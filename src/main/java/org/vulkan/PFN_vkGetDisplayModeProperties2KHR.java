...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkGetDisplayModeProperties2KHR)(VkPhysicalDevice, VkDisplayKHR, uint32_t *, VkDisplayModeProperties2KHR *)
 * }
 */
public class PFN_vkGetDisplayModeProperties2KHR {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetDisplayModeProperties2KHR.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkGetDisplayModeProperties2KHR.Function fi, Arena arena) {
