...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkGetImageSparseMemoryRequirements2)(VkDevice, const VkImageSparseMemoryRequirementsInfo2 *, uint32_t *, VkSparseImageMemoryRequirements2 *)
 * }
 */
public class PFN_vkGetImageSparseMemoryRequirements2 {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetImageSparseMemoryRequirements2.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkGetImageSparseMemoryRequirements2.Function fi, Arena arena) {
