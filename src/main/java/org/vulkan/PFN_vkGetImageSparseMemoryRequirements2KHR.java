...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkGetImageSparseMemoryRequirements2KHR)(VkDevice, const VkImageSparseMemoryRequirementsInfo2 *, uint32_t *, VkSparseImageMemoryRequirements2 *)
 * }
 */
public class PFN_vkGetImageSparseMemoryRequirements2KHR {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetImageSparseMemoryRequirements2KHR.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkGetImageSparseMemoryRequirements2KHR.Function fi, Arena arena) {
