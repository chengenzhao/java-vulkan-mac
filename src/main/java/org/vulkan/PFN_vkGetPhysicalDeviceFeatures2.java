 ...
 * }
 */
public class PFN_vkGetPhysicalDeviceFeatures2 {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetPhysicalDeviceFeatures2.Function.class, "apply", $DESC);
