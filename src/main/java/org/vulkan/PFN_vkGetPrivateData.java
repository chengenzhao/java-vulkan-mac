...
/**
 * {@snippet lang=c :
 * typedef void (*PFN_vkGetPrivateData)(VkDevice, VkObjectType, uint64_t, VkPrivateDataSlot, uint64_t *)
 * }
 */
public class PFN_vkGetPrivateData {
    ...
    private static final MethodHandle UP$MH = vulkan_h.upcallHandle(PFN_vkGetPrivateData.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFN_vkGetPrivateData.Function fi, Arena arena) {
