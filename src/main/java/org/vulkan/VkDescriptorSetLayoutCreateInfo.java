...
public class VkDescriptorSetLayoutCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        vulkan_h.C_POINTER.withName("pBindings")
    ...
    private static final long bindingCount$OFFSET = 20;
    ...
    private static final AddressLayout pBindings$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pBindings"));
     ...
     * }
     */
    public static final AddressLayout pBindings$layout() {
        return pBindings$LAYOUT;
    }

    private static final long pBindings$OFFSET = 24;
     ...
     * }
     */
    public static final long pBindings$offset() {
        return pBindings$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pBindings(MemorySegment struct) {
        return struct.get(pBindings$LAYOUT, pBindings$OFFSET);
    }
     ...
     * }
     */
    public static void pBindings(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pBindings$LAYOUT, pBindings$OFFSET, fieldValue);
    }
