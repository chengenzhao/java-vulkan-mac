...
public class VkDeviceQueueCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        vulkan_h.C_POINTER.withName("pQueuePriorities")
    ...
    private static final long queueFamilyIndex$OFFSET = 20;
    ...
    private static final long queueCount$OFFSET = 24;
    ...
    private static final AddressLayout pQueuePriorities$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pQueuePriorities"));
     ...
     * }
     */
    public static final AddressLayout pQueuePriorities$layout() {
        return pQueuePriorities$LAYOUT;
    }

    private static final long pQueuePriorities$OFFSET = 32;
     ...
     * }
     */
    public static final long pQueuePriorities$offset() {
        return pQueuePriorities$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pQueuePriorities(MemorySegment struct) {
        return struct.get(pQueuePriorities$LAYOUT, pQueuePriorities$OFFSET);
    }
     ...
     * }
     */
    public static void pQueuePriorities(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pQueuePriorities$LAYOUT, pQueuePriorities$OFFSET, fieldValue);
    }
