...
public class VkGeometryDataNV {
     ...
     * }
     */
    public static MemorySegment triangles(MemorySegment struct) {
        return struct.asSlice(triangles$OFFSET, triangles$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void triangles(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, triangles$OFFSET, triangles$LAYOUT.byteSize());
    }
    ...
    private static final long aabbs$OFFSET = 96;
     ...
     * }
     */
    public static MemorySegment aabbs(MemorySegment struct) {
        return struct.asSlice(aabbs$OFFSET, aabbs$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void aabbs(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, aabbs$OFFSET, aabbs$LAYOUT.byteSize());
    }
