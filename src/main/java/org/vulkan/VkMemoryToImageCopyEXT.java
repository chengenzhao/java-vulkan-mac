...
public class VkMemoryToImageCopyEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        vulkan_h.C_POINTER.withName("pHostPointer"),
        vulkan_h.C_INT.withName("memoryRowLength"),
        vulkan_h.C_INT.withName("memoryImageHeight"),
    ...
    private static final AddressLayout pHostPointer$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pHostPointer"));
     ...
     * }
     */
    public static final AddressLayout pHostPointer$layout() {
        return pHostPointer$LAYOUT;
    }

    private static final long pHostPointer$OFFSET = 16;
     ...
     * }
     */
    public static final long pHostPointer$offset() {
        return pHostPointer$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pHostPointer(MemorySegment struct) {
        return struct.get(pHostPointer$LAYOUT, pHostPointer$OFFSET);
    }
     ...
     * }
     */
    public static void pHostPointer(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pHostPointer$LAYOUT, pHostPointer$OFFSET, fieldValue);
    }

    private static final OfInt memoryRowLength$LAYOUT = (OfInt)$LAYOUT.select(groupElement("memoryRowLength"));
     ...
     * }
     */
    public static final OfInt memoryRowLength$layout() {
        return memoryRowLength$LAYOUT;
    }

    private static final long memoryRowLength$OFFSET = 24;
     ...
     * }
     */
    public static final long memoryRowLength$offset() {
        return memoryRowLength$OFFSET;
    }
     ...
     * }
     */
    public static int memoryRowLength(MemorySegment struct) {
        return struct.get(memoryRowLength$LAYOUT, memoryRowLength$OFFSET);
    }
     ...
     * }
     */
    public static void memoryRowLength(MemorySegment struct, int fieldValue) {
        struct.set(memoryRowLength$LAYOUT, memoryRowLength$OFFSET, fieldValue);
    }

    private static final OfInt memoryImageHeight$LAYOUT = (OfInt)$LAYOUT.select(groupElement("memoryImageHeight"));
     ...
     * }
     */
    public static final OfInt memoryImageHeight$layout() {
        return memoryImageHeight$LAYOUT;
    }

    private static final long memoryImageHeight$OFFSET = 28;
     ...
     * }
     */
    public static final long memoryImageHeight$offset() {
        return memoryImageHeight$OFFSET;
    }
     ...
     * }
     */
    public static int memoryImageHeight(MemorySegment struct) {
        return struct.get(memoryImageHeight$LAYOUT, memoryImageHeight$OFFSET);
    }
     ...
     * }
     */
    public static void memoryImageHeight(MemorySegment struct, int fieldValue) {
        struct.set(memoryImageHeight$LAYOUT, memoryImageHeight$OFFSET, fieldValue);
    }
