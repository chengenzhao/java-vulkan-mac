...
public class VkPresentIdKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        vulkan_h.C_POINTER.withName("pPresentIds")
    ...
    private static final AddressLayout pPresentIds$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pPresentIds"));
     ...
     * }
     */
    public static final AddressLayout pPresentIds$layout() {
        return pPresentIds$LAYOUT;
    }

    private static final long pPresentIds$OFFSET = 24;
     ...
     * }
     */
    public static final long pPresentIds$offset() {
        return pPresentIds$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pPresentIds(MemorySegment struct) {
        return struct.get(pPresentIds$LAYOUT, pPresentIds$OFFSET);
    }
     ...
     * }
     */
    public static void pPresentIds(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pPresentIds$LAYOUT, pPresentIds$OFFSET, fieldValue);
    }
