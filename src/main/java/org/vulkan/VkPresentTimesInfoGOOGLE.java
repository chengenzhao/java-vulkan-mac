...
public class VkPresentTimesInfoGOOGLE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        vulkan_h.C_POINTER.withName("pTimes")
    ...
    private static final AddressLayout pTimes$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pTimes"));
     ...
     * }
     */
    public static final AddressLayout pTimes$layout() {
        return pTimes$LAYOUT;
    }

    private static final long pTimes$OFFSET = 24;
     ...
     * }
     */
    public static final long pTimes$offset() {
        return pTimes$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pTimes(MemorySegment struct) {
        return struct.get(pTimes$LAYOUT, pTimes$OFFSET);
    }
     ...
     * }
     */
    public static void pTimes(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pTimes$LAYOUT, pTimes$OFFSET, fieldValue);
    }
