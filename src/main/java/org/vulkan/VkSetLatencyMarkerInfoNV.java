 ...
 * }
 */
public class VkSetLatencyMarkerInfoNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        vulkan_h.C_INT.withName("marker"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final OfInt marker$LAYOUT = (OfInt)$LAYOUT.select(groupElement("marker"));
     ...
     * }
     */
    public static final OfInt marker$layout() {
        return marker$LAYOUT;
    }

    private static final long marker$OFFSET = 24;
     ...
     * }
     */
    public static int marker(MemorySegment struct) {
     ...
     * }
     */
    public static void marker(MemorySegment struct, int fieldValue) {
