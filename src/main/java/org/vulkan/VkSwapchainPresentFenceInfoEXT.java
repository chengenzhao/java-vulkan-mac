 ...
 * }
 */
public class VkSwapchainPresentFenceInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        vulkan_h.C_POINTER.withName("pFences")
    ...
    private static final AddressLayout pFences$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pFences"));
     ...
     * }
     */
    public static final AddressLayout pFences$layout() {
        return pFences$LAYOUT;
    }

    private static final long pFences$OFFSET = 24;
     ...
     * }
     */
    public static final long pFences$offset() {
        return pFences$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pFences(MemorySegment struct) {
        return struct.get(pFences$LAYOUT, pFences$OFFSET);
    }
     ...
     * }
     */
    public static void pFences(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pFences$LAYOUT, pFences$OFFSET, fieldValue);
    }
