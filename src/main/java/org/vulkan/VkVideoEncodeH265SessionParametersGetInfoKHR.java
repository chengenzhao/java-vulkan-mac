 ...
 * }
 */
public class VkVideoEncodeH265SessionParametersGetInfoKHR {
    ...
    private static final OfInt writeStdVPS$LAYOUT = (OfInt)$LAYOUT.select(groupElement("writeStdVPS"));
     ...
     * }
     */
    public static final OfInt writeStdVPS$layout() {
        return writeStdVPS$LAYOUT;
    }

    private static final long writeStdVPS$OFFSET = 16;
     ...
     * }
     */
    public static final long writeStdVPS$offset() {
        return writeStdVPS$OFFSET;
    }
     ...
     * }
     */
    public static int writeStdVPS(MemorySegment struct) {
        return struct.get(writeStdVPS$LAYOUT, writeStdVPS$OFFSET);
    }
     ...
     * }
     */
    public static void writeStdVPS(MemorySegment struct, int fieldValue) {
        struct.set(writeStdVPS$LAYOUT, writeStdVPS$OFFSET, fieldValue);
    }
    ...
    private static final long writeStdSPS$OFFSET = 20;
    ...
    private static final long writeStdPPS$OFFSET = 24;
    ...
    private static final OfInt stdVPSId$LAYOUT = (OfInt)$LAYOUT.select(groupElement("stdVPSId"));
     ...
     * }
     */
    public static final OfInt stdVPSId$layout() {
        return stdVPSId$LAYOUT;
    }

    private static final long stdVPSId$OFFSET = 28;
     ...
     * }
     */
    public static final long stdVPSId$offset() {
        return stdVPSId$OFFSET;
    }
     ...
     * }
     */
    public static int stdVPSId(MemorySegment struct) {
        return struct.get(stdVPSId$LAYOUT, stdVPSId$OFFSET);
    }
     ...
     * }
     */
    public static void stdVPSId(MemorySegment struct, int fieldValue) {
        struct.set(stdVPSId$LAYOUT, stdVPSId$OFFSET, fieldValue);
    }
    ...
    private static final long stdSPSId$OFFSET = 32;
    ...
    private static final long stdPPSId$OFFSET = 36;
