 ...
 * }
 */
public class VkVideoEncodeSessionParametersGetInfoKHR {
    ...
    ).withName("VkVideoEncodeSessionParametersGetInfoKHR");
    ...
    private static final long videoSessionParameters$OFFSET = 16;
