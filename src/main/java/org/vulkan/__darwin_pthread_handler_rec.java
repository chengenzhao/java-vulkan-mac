...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        vulkan_h.C_POINTER.withName("__routine"),
        vulkan_h.C_POINTER.withName("__arg"),
        vulkan_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = vulkan_h.upcallHandle(__routine.Function.class, "apply", $DESC);
